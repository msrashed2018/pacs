# [Material Dashboard Angular - Free Bootstrap Material Design Admin](https://www.creative-tim.com/product/khedma-admin2)[![version][version-badge]][CHANGELOG]

![Product Gif](https://raw.githubusercontent.com/creativetimofficial/public-assets/master/khedma-admin/khedma-admin.gif)
...
│   │   │   ├── subscription.component.spec.ts
...
│   │   └── user-profile
│   │       ├── properity.component.css
│   │       ├── properity.component.html
│   │       ├── properity.component.spec.ts
│   │       └── properity.component.ts
│   ├── assets
│   │   ├── css
│   │   │   └── demo.css
│   │   ├── img
